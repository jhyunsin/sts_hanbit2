...
--DROP PROCEDURE GKSQLC.INSERTMEMBER;
/*
============ MAJOR ==========
@AUTHOR : Jhyunsin@gmail.com
...
END insert_major;
-- EXE_INSERT_MAJOR
EXEC GKSQLC.INSERT_MAJOR('컴퓨터공학');
-- DEF_COUNT_MAJOR
...
CREATE OR REPLACE PROCEDURE GKSQLC.all_major(
...
END insert_prof;
-- EXE_INSERT_PROF
EXEC GKSQLC.INSERT_PROF('prof_james','1','제임스 고슬링','MALE','2010-06-01','550101-1','prof_james@test.com','default.jpg','PROF','010-1234-5678');
-- DEF_COUNT_PROF
...
-- EXE_COUNT_PROF
DECLARE sp_count NUMBER:=0;BEGIN count_prof(sp_count);DBMS_OUTPUT.put_line ('교수인원 : '||sp_count||' 명');END;
-- DEF_EXIST_MEMBER_ID
...
END exist_member_id;
-- EXE_EXIST_MEMBER_ID
DECLARE sp_mem_id VARCHAR2(30) := 'hong';sp_count NUMBER;BEGIN exist_member_id(sp_mem_id,sp_count);DBMS_OUTPUT.put_line ('조회결과 : '||sp_count||' 명');END;
-- DEF_FIND_BY_PROF_ID
...
-- EXE_FIND_BY_PROF_ID
DECLARE
    sp_prof_id VARCHAR2(100) := 'prof_james';
 ...
 CREATE OR REPLACE PROCEDURE GKSQLC.all_prof(
...
AS BEGIN UPDATE Member SET pw=sp_pw, email = sp_email, phone = sp_phone WHERE mem_id = sp_prof_id;
END update_prof; 
--ExE_UPDATE_PROF
...
END insert_student;
-- EXE_INSERT_STUDENT
EXEC GKSQLC.INSERT_STUDENT('hong','1','홍길동','MALE','2016-06-01','800101-1','hong@test.com','default.jpg','STUDENT','010-1234-5678','1001');
-- DEF_ALL_STUDENT
...
END insert_subject;
-- EXE_INSERT_SUBJECT
EXEC GKSQLC.INSERT_SUBJECT('java','profx');
/*
=========== EXAM ===========
@AUTHOR : Jhyunsin@gmail.com
@CREATE DATE : 2016-9-8
